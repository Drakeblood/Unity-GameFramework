...
namespace SimpleFolderIcon.Editor
{
    ...
    {
        private const string AssetsPath = "Packs/SimpleFolderIcon/Icons";
        ...
        internal static void BuildDictionary()
        {
            ...
            {
                var texture = (Texture)AssetDatabase.LoadAssetAtPath($"Assets/Packs/SimpleFolderIcon/Icons/{f.Name}", typeof(Texture2D));
